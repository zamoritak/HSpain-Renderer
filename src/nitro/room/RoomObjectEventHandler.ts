...
export class RoomObjectEventHandler extends Disposable implements IRoomCanvasMouseListener, IRoomObjectEventManager
{
    ...
    private clickRoomObject(event: RoomObjectMouseEvent, operation: string): void
    {
        ...
        {
            this._roomEngine.connection.send(new ClickFurniMessageComposer(objectId, category));
        ...
        if(category === RoomObjectCategory.WALL)
        {
            ...
            this._roomEngine.connection.send(new ClickFurniMessageComposer(-Math.abs(objectId), category));
        ...
        {
            this._roomEngine.connection.send(new ClickUserMessageComposer(objectId));
        }
    }
