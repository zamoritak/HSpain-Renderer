...
import { AccountSafetyLockStatusChangeMessageEvent, AccountSafetyLockStatusChangeParser, AvailabilityStatusMessageEvent, ChangeUserNameResultMessageEvent, CommandMessageData, CommandMessageEvent, EmailStatusResultEvent, FigureUpdateEvent, GetUserTagsComposer, InClientLinkEvent, MysteryBoxKeysEvent, NoobnessLevelMessageEvent, PetRespectComposer, PetScratchFailedMessageEvent, RoomReadyMessageEvent, RoomUnitChatComposer, StickerMessageData, StickerMessageEvent, UserInfoEvent, UserNameChangeMessageEvent, UserPermissionsEvent, UserRespectComposer, UserTagsMessageEvent } from '../communication';
...
export class SessionDataManager extends NitroManager implements ISessionDataManager
{
    ...
    protected onInit(): void
    {
        ...
        this._communication.registerMessageEvent(new StickerMessageEvent(this.onStickers.bind(this)));
        this._communication.registerMessageEvent(new CommandMessageEvent(this.onCommands.bind(this)));
    ...
    private onUserInfoEvent(event: UserInfoEvent): void
    {
        ...
        this._nivelPesca = userInfo.nivelPesca;
        this._expPesca = userInfo.expPesca;
        this._creditosPesca = userInfo.creditosPesca || 0;
        this._usosCañaPesca = userInfo.usosCañaPesca || 0;
        this._capturasBotas = userInfo.capturasBotas || 0;
        this._capturasComunPesca = userInfo.capturasComunPesca || 0;
        this._capturasMisterioso = userInfo.capturasMisterioso || 0;
        this._capturasRaro = userInfo.capturasRaro || 0;
        this._jailEndTime = userInfo.jailEndTime || 0;
        this._jailStaffLook = userInfo.jailStaffLook || "";
        this._jailStaffName = userInfo.jailStaffName || "";
        this._hotelState = userInfo.hotelState || "EQUILIBRIO";
        this._hotelEventEndTime = userInfo.hotelEventEndTime || 0;
    ...
    private onEmailStatus(event: EmailStatusResultEvent): void
    {
        ...
        private onStickers(event: StickerMessageEvent): void
    {
        if(!event) return;
        ...
        this._stickers = parser.stickers;
    }

    public getAllStickers(): StickerMessageData[]
    {
        const stickers = this._stickers;
        ...
        private onCommands(event: CommandMessageEvent): void
    {
        if(!event) return;
        ...
        this._commands = parser.commands;
    }

    public getAllCommands(): CommandMessageData[]
    {
