export class UserMessageData
{
    ...
    private _usernameIcon: number = 0; 
    private _usernameEffect: number = 0; 
    private _ornament: number = 0;
    ...
    {
        return this._usernameIcon;
    }

    public set usernameIcon(k: number)
    {
        if(!this._isReadOnly)
        {
            this._usernameIcon = k;
        }
    }

    public get usernameEffect(): number
    {
        return this._usernameEffect;
    }

    public set usernameEffect(k: number)
    {
        if(!this._isReadOnly)
        {
            this._usernameEffect = k;
        }
    }
