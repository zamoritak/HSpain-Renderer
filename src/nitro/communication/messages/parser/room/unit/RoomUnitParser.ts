...
export class RoomUnitParser implements IMessageParser
{
    ...
    public parse(wrapper: IMessageDataWrapper): boolean
    {
        ...
        while(i < totalUsers)
        {
            ...
            const usernameIcon = wrapper.readInt();
            const usernameEffect = wrapper.readInt();
            const ornament = wrapper.readInt();
            const textColor = wrapper.readInt();
            ...
            user.usernameIcon = usernameIcon;      // Icono del nombre
            user.usernameEffect = usernameEffect;    // Efecto del nombre
            user.ornament = ornament;  
            user.textColor = textColor;         // Color del texto
