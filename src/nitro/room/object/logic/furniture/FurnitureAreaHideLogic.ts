...
import { RoomObjectEvent, RoomObjectStateChangedEvent, RoomObjectWidgetRequestEvent, RoomSpriteMouseEvent } from '../../../../../events';
...
export class FurnitureAreaHideLogic extends FurnitureMultiStateLogic
{
    ...
    private setupObject(): void
    {
        ...
        const blockWalking = (numberData.getValue(8) === 1);
        const alphaHide = (numberData.getValue(9) === 1);
        ...
        this.object.model.setValue(RoomObjectVariable.FURNITURE_AREA_HIDE_BLOCK_WALKING, ((blockWalking) ? 1 : 0));
        this.object.model.setValue(RoomObjectVariable.FURNITURE_AREA_HIDE_HIDE_FURNITURE, ((alphaHide) ? 1 : 0));
