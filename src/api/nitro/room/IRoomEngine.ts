...
import { IRoomAreaSelectionManager, IRoomGeometry, IRoomManager, IRoomObject, IRoomObjectController, IRoomObjectLogicFactory, IRoomObjectVisualizationFactory, IRoomRendererFactory, IRoomRenderingCanvas, IVector3D } from '../../room';
...
export interface IRoomEngine extends INitroManager
{
    ...
    updateAreaHide(roomId: number, furniId: number, on: boolean, rootX: number, rootY: number, width: number, length: number, invert: boolean, invisibility?: boolean, wallItems?: boolean, canWalk?: boolean, alphaHide?: boolean): boolean;
