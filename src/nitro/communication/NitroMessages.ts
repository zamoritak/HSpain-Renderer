...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        // HSPAIN MARKETPLACE
        this._events.set(IncomingHeader.HS_MARKETPLACE_LISTINGS, HSMarketplaceListingsEvent);
        this._events.set(IncomingHeader.HS_MARKETPLACE_HISTORY, HSMarketplaceHistoryEvent);
        this._events.set(IncomingHeader.HS_MARKETPLACE_DASHBOARD, HSMarketplaceDashboardEvent);
        this._events.set(IncomingHeader.HS_MARKETPLACE_SECURITY_CODE, HSMarketplaceSecurityCodeEvent);
        this._events.set(IncomingHeader.HS_MARKETPLACE_OFFERS, HSMarketplaceOffersEvent);

        // COFRES
        this._events.set(IncomingHeader.GET_CASES_LIST, GetCasesListEvent);
        this._events.set(IncomingHeader.GET_CASE_ITEMS, GetCaseItemsEvent);
        this._events.set(IncomingHeader.OPEN_CASE_CONFIRM, OpenCaseConfirmEvent);
        this._events.set(IncomingHeader.OPEN_CASE_RESULT, OpenCaseResultEvent);
        ...
        this._events.set(IncomingHeader.GET_LATEST_MENTIONS, GetLatestMentionsEvent)
        this._events.set(IncomingHeader.STAFF_SHIFT_STATUS, StaffShiftStatusEvent)
        ...
        // KUBBO
        this._events.set(IncomingHeader.STICKER_LIST, StickerMessageEvent);
        this._events.set(IncomingHeader.COMMAND_LIST, CommandMessageEvent);

        // PESCA
        this._events.set(IncomingHeader.FISHING_CANES, FishingCanesEvent);
        this._events.set(IncomingHeader.USER_FISHING_CANES, UserFishingCanesEvent);
        this._events.set(IncomingHeader.FISHING_CAPTURE, FishingCaptureEvent);
        this._events.set(IncomingHeader.PESCA_DATA, PescaDataEvent);
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.UNIT_GET_HANDITEM, RoomUnitGetHanditemComposer);
        ...
        this._composers.set(OutgoingHeader.USER_SETTINGS_INFOSTAND_TEXTCOLOR, RoomUnitTextColorComposer);
        this._composers.set(OutgoingHeader.USER_SETTINGS_INFOSTAND_USERNAME_ICON, RoomUnitUsernameIconComposer);
        this._composers.set(OutgoingHeader.USER_SETTINGS_INFOSTAND_USERNAME_EFFECT, RoomUnitUsernameEffectComposer);
        this._composers.set(OutgoingHeader.USER_SETTINGS_INFOSTAND_ORNAMENT, RoomUnitOrnamentComposer);
        ...
        this._composers.set(OutgoingHeader.GET_LATEST_MENTIONS, GetLatestMentionsComposer);
        this._composers.set(OutgoingHeader.GET_STAFF_SHIFT_STATUS, GetStaffShiftStatusComposer);
        this._composers.set(OutgoingHeader.START_STAFF_SHIFT, StartStaffShiftComposer);
        this._composers.set(OutgoingHeader.PAUSE_STAFF_SHIFT, PauseStaffShiftComposer);
        this._composers.set(OutgoingHeader.RESUME_STAFF_SHIFT, ResumeStaffShiftComposer);
        this._composers.set(OutgoingHeader.END_STAFF_SHIFT, EndStaffShiftComposer);
        this._composers.set(OutgoingHeader.UPDATE_BANNER, UpdateBannerComposer);
        ...
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_SEARCH, HSMarketplaceSearchComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_POST, HSMarketplacePostItemComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_BUY, HSMarketplaceBuyComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_OFFER, HSMarketplaceOfferComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_CANCEL, HSMarketplaceCancelComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_UPDATE, HSMarketplaceUpdateComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_HISTORY, HSMarketplaceHistoryComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_DASHBOARD, HSMarketplaceDashboardComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_GENERATE_CODE, HSMarketplaceGenerateCodeComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_UNLINK, HSMarketplaceUnlinkComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_ACCEPT_OFFER, HSMarketplaceAcceptOfferComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_REJECT_OFFER, HSMarketplaceRejectOfferComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_CANCEL_OFFER, HSMarketplaceCancelOfferComposer);
        this._composers.set(OutgoingHeader.HS_MARKETPLACE_REQUEST_OFFERS, HSMarketplaceRequestOffersComposer);
        ...
        // COFRES 
        this._composers.set(OutgoingHeader.OPEN_CASE, OpenCaseComposer);
        this._composers.set(OutgoingHeader.GET_CASES_LIST, GetCasesListComposer);
        this._composers.set(OutgoingHeader.GET_CASE_ITEMS, GetCaseItemsComposer);

        // HERRAMIENTAS KUBBO
        this._composers.set(OutgoingHeader.KUBBO_CUSTOM, KubboMessageComposer);

        // PESCA
        this._composers.set(OutgoingHeader.PESCA_START_FISHING, StartFishingModeComposer);
        this._composers.set(OutgoingHeader.PESCA_BUY_FISHING_CANE, BuyFishingCaneComposer);
        this._composers.set(OutgoingHeader.PESCA_GET_FISHING_CANES, GetFishingCanesComposer);
        this._composers.set(OutgoingHeader.PESCA_GET_USER_FISHING_CANES, GetUserFishingCanesComposer);
        this._composers.set(OutgoingHeader.PESCA_EQUIP_FISHING_CANE, EquipFishingCaneComposer);
        this._composers.set(OutgoingHeader.PESCA_SELL_FISHES, SellCapturedFishesComposer);
