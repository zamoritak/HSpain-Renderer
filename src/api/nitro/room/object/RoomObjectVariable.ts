export class RoomObjectVariable
{
    ...
    public static FURNITURE_AREA_HIDE_BLOCK_WALKING: string = 'furniture_area_hide_block_walking';
    public static FURNITURE_AREA_HIDE_HIDE_FURNITURE: string = 'furniture_area_hide_hide_furniture';
    public static ROOM_SELECTION_ACTIVE: string = 'room_selection_active';
}
