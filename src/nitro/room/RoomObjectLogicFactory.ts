import { IEventDispatcher, INitroEvent, IRoomObjectEventHandler, IRoomObjectLogicFactory, NitroLogger, RoomObjectLogicType } from '../../api';
...
type EventCallback = (event: INitroEvent | RoomObjectEvent) => void;
...
export class RoomObjectLogicFactory implements IRoomObjectLogicFactory
{
    ...
    private _functions: EventCallback[];
    ...
    public registerEventFunction(func: EventCallback): void
    {
        if(!func) return;
    ...
    public removeEventFunction(func: EventCallback): void
    {
        if(!func) return;
