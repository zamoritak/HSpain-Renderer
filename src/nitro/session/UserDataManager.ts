...
): void
{
    ...
    userData.stand = backgroundStand;
    userData.overlay = backgroundOverlay;

    // Actualizar apariencia adicional
    userData.usernameIcon = usernameIcon;
    userData.usernameEffect = usernameEffect;
    userData.ornament = ornament;
